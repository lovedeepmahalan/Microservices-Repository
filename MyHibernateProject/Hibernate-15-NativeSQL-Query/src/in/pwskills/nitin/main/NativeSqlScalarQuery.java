...
public class NativeSqlScalarQuery {
	@SuppressWarnings("unchecked")
	public static void main(String[] args) {
		Session session=HibernateUtil.getSession();
		try {
		NativeQuery<String> query=session.createSQLQuery("SELECT policyName FROM insurancepolicy WHERE tenure>=:min and tenure<=:max");
